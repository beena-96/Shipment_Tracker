...
export default async function handler(req, res) {
  try {
    ...
    const insertQueryManagerTable = `INSERT INTO Users (UserName, Password, Email, Role) VALUES ('${UserName}', '${Password}', '${Email}', '${Role}')`;

    await client.query(insertQueryManagerTable);
