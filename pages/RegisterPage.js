...
const RegisterPage = () => {
    ...
    var showInputDriverFields = false
    if (Role == 'Driver') {
        showInputDriverFields = true
    }
                            ...
                            <div>
                                <div className="flex -mx-3">
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" id="inline-full-Username" placeholder="" name="UserName" value={UserName} onChange={(e) => {
                                    ...
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <select
                                                ...
                                                id="inline-full-Role" name="Role" value={Role}
                                                onChange={(e) => {
                                        ...
                                        {formik.touched.Role && formik.errors.Role ? (
                                            <div className="text-red-500 rounded text-xs font-medium uppercase leading-normal">{formik.errors.Role}</div>
                                        ) : null}
                                    </div>
                                </div>


                                {showInputDriverFields && (
                                    <div>
                                        <div className="flex -mx-3">
                                            <div className="w-1/2 px-3 mb-5">
                                                <label className="text-xs font-semibold px-1">Vehicle Number</label>
                                                <div className="flex">
                                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" id="inline-full-VehicleNumber" placeholder="" name="VehicleNumber"
                                                ...
                                                {formik.touched.VehicleNumber && formik.errors.VehicleNumber ? (
                                                    <div className="text-red-500 rounded text-xs font-medium uppercase leading-normal">{formik.errors.VehicleNumber}</div>
                                                ) : null}
                                            </div>
                                            <div className="w-1/2 px-3 mb-5">
                                                <label className="text-xs font-semibold px-1">License Number</label>
                                                <div className="flex">
                                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" id="inline-full-LicenseNumber" placeholder="" name="LicenseNumber"
                                                        value={LicenseNumber} onChange={(e) => {
                                                ...
                                                {formik.touched.LicenseNumber && formik.errors.LicenseNumber ? (
                                                    <div className="text-red-500 rounded text-xs font-medium uppercase leading-normal">{formik.errors.LicenseNumber}</div>
                                                ) : null}
                                            </div>
                                        </div>
                                        <div className="flex -mx-3">
                                            <div className="w-full px-3 mb-5">
                                                <label className="text-xs font-semibold px-1">Contact Number</label>
                                                <div className="flex">
                                                    ...
                                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder=""
                                                        id="inline-full-ContactNumber" name="ContactNumber"
                                                ...
                                                {formik.touched.ContactNumber && formik.errors.ContactNumber ? (
                                                    <div className="text-red-500 rounded text-xs font-medium uppercase leading-normal">{formik.errors.ContactNumber}</div>
                                                ) : null}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="beena@gmail.com"
                                                id="inline-full-Email" name="Email" value={Email} onChange={(e) => {
                                        ...
                                        {formik.touched.Email && formik.errors.Email ? (
                                            <div className="text-red-500 rounded text-xs font-medium uppercase leading-normal">{formik.errors.Email}</div>
                                        ) : null}
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"
                                                id="inline-full-Password" name="Password" value={Password} onChange={(e) => {
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button type="button" className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" onClick={formik.handleSubmit}>REGISTER NOW</button>
                                        <ToastContainer />
                                    </div>
                                </div>
                            </div>
            ...
            <div className="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
                <div>
                    <a title="Buy me a beer" href="https://www.buymeacoffee.com/scottwindon" target="_blank" className="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
                        <img className="object-cover object-center w-full h-full rounded-full" src="https://cdn.pixabay.com/photo/2020/12/27/20/24/smile-5865208_1280.png" />
                    </a>
                </div>
            </div>
        </div>
