...
const ShipmentTable = () => {
  ...
  useEffect(() => {
    ...
    fetch('/api/selectDataManagerTable')
  ...
  return (
    <div>
 <div class="flex">
                        <h6 class="font-bold uppercase text-2xl" style={{marginLeft:"20%",marginTop:"2%" }}>Manager Details</h6>
                    </div>
      <div class="container flex justify-center mx-auto" style={{marginLeft:"16%",width:"58%",marginTop:"2%"}}>
